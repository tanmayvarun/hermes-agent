...
export const en: Translations = {
  ...
  boot: {
    ready: 'Plugin Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Plugin settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Plugin Desktop…'
    },
    errors: {
      backgroundExited: 'Plugin background process exited.',
      backgroundExitedDuringStartup: 'Plugin background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Plugin backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Plugin',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Plugin Desktop.',
    ...
    native: {
      ...
      inputBody: 'Plugin is waiting for your response.',
      turnDoneTitle: 'Plugin finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Plugin defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Plugin writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Plugin is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Plugin asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Plugin was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Plugin follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Plugin is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Plugin, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Plugin checks for updates automatically in the background and lets you know when one is ready.',
    ...
    gateway: {
      ...
      intro:
        'Plugin Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Plugin backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Plugin backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Plugin backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Plugin Cloud',
      cloudDesc: 'Sign in once to Plugin Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Plugin Cloud',
      cloudSignIn: 'Sign in to Plugin Cloud',
      cloudSignedIn: 'Signed in to Plugin Cloud',
      cloudNeedsSignIn: 'Sign in to Plugin Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Plugin Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Plugin Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Plugin Cloud',
      cloudSignedOutMessage: 'Cleared the Plugin Cloud session.',
      ...
      restartingMessage: 'Plugin Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Plugin ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Plugin runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Plugin at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As Plugin builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Plugin to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Plugin to generate pets.',
      backgroundHint: 'You can close this — Plugin will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Plugin desktop' },
    ...
    hermesActiveSessions: (version, count) => `Plugin ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Plugin environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Plugin will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Plugin backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Plugin. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Plugin...',
    placeholderReconnecting: 'Reconnecting to Plugin…',
    ...
    attachUrlDesc: 'Plugin will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Plugin to open PR',
      agentShipPrompt:
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Plugin can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Plugin is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Plugin backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Plugin from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Plugin will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Plugin desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Plugin updater takes over in its own window and reopens Plugin automatically when it’s done. Please don’t reopen Plugin yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Plugin reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Plugin reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Plugin needs a one-time install',
    ...
    settingUpTitle: 'Setting up Plugin Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Plugin CLI or desktop instance is running. Stop any running Plugin instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Plugin installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Plugin Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Plugin is finishing install. This usually takes under a minute on first run.',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Plugin',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Plugin at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Plugin connects automatically',
    ...
    authorizeThere: 'Authorize Plugin there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Plugin there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Plugin inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Plugin will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Plugin is restarting...',
      askRestart: 'Ask Plugin to restart the server',
      lookingRestart: taskId => `Plugin is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Plugin is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Plugin finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Plugin could not restart the server.',
      stillWorking:
        'Plugin is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Plugin is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Plugin gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Plugin won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Plugin needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Plugin needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Plugin Desktop to use Save Image.',
    restartToSaveImages: 'Restart Plugin Desktop to save images',
