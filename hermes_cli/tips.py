...
TIPS = [
    ...
    "/theme light|dark|auto sets contrast — skins only change branding.",
    "/skin changes branding (name/logo) — try ares, mono, slate, poseidon, or charizard.",
    ...
    "Set fallback_providers in config.yaml to define the ordered model list Hermes tries next.",
