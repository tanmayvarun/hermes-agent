#!/bin/bash
# Live Call Pallavi under Terminal.app — waits until Accessibility is granted.
set -u
...
CONSOLE="$RUN_DIR/terminal_live_${STAMP}_console.txt"
STATUS="$RUN_DIR/terminal_live_${STAMP}_status.txt"
...
PY
  ...
  # Keep WhatsApp frontmost; do not open System Settings (steals keystrokes).
  open -a WhatsApp
  sleep 1.5

  echo "=== starting call-pallavi --live ==="
