...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("skin", "Show or change branding skin (name/logo — not contrast)", "Configuration",
               cli_only=True, args_hint="[name]"),
    CommandDef("theme", "Set contrast mode: light, dark, or auto", "Configuration",
               cli_only=True, args_hint="[light|dark|auto]",
               subcommands=("light", "dark", "auto")),
